...
class Metadata
{
    public static $objects = array(
        ...
        'product' => array(
            ...
            'links' => array(
                'picture' => array('table' => 'product_picture', 'field' => 'picture_product', 'ondelete' => 'cascade'),
            ),
            'relations' => array(
        ...
        'marker' => array(
            ...
            'fields' => array(
                ...
                'marker_legend' => array( 'title' => 'Надпись', 'type' => 'string', 'errors' => 'require' ),
                'marker_link' => array( 'title' => 'Ссылка', 'type' => 'string', 'errors' => 'require' ),
            ),
            'relations' => array(
        ...
        'purchase' => array(
            ...
            'fields' => array(
                ...
                'purchase_client' => array('title' => 'Контактное лицо', 'type' => 'string', 'main' => 1, 'errors' => 'require'),
                'purchase_email' => array('title' => 'Email', 'type' => 'string', 'errors' => 'email'),
